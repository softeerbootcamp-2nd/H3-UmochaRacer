...
class OptionCardButtonViewController: UIViewController {
    ...
    @objc private func animateButtons() {
        self.selfModeBasicButton.animateButton(title: "디젤 엔진은 효율이 좋아요!", description: "효율을 중시한다면, 탁월한 선택입니다.")
        self.guideModeBasicButton.animateButton(title: "디젤 엔진은 효율이 좋아요!", description: "효율을 중시한다면, 탁월한 선택입니다.")
    }
}
